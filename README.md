...
```sh
apt install libgirepository-2.0-dev libcairo2-dev pkg-config python3-dev gir1.2-gstreamer-1.0 gstreamer1.0-tools gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-libav
```
